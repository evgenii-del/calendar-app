...
describe('test Server class', () => {
  const dataArr = [
    {
      data:
        '{"date":"14-Friday","reserved":true,"participants":["1"],"title":"Task 7","color":"green"}',
      id: 'dbfc775b-e102-435e-ba71-49a71641d129'
    },
    {
      data:
        '{"date":"15-Monday","reserved":true,"participants":["1"],"title":"Task 123","color":"yellow"}',
  ...
  test('test post createEvent', async () => {
    const data = {
      data:
        '{"date":"11-Monday","reserved":true,"participants":["3"],"title":"Task 1","color":"green"}',
